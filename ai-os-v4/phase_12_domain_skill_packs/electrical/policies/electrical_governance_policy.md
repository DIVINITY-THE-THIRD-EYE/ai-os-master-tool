---
title: "Electrical Safety, Insulation, and EMI/EMC Compliance Policy"
document_id: "SPEC-P12-ELEC-POL-001"
...
# Electrical Safety, Insulation, and EMI/EMC Compliance Policy

## 1. Policy Purpose & Authority
This policy establishes binding operational, safety, and regulatory compliance rules for all tasks executed in the **Electrical & Power Engineering** domain. It derives authority from the enterprise AI OS v4 Runtime Policy Engine and enforces strict compliance with international standards: **IEEE 1584, IPC-2221, IEC 61000, NEC (NFPA 70), UL 60950-1**.

---

## 2. Scope & Applicability
This policy applies to:
1. All AI OS agents executing in the `electrical` domain context.
...
Every generated artifact MUST explicitly reference and comply with at least one governing standard from: `IEEE 1584, IPC-2221, IEC 61000, NEC (NFPA 70), UL 60950-1`. Non-compliant deliverables MUST be automatically rejected at the verification gate.

### Rule 2: Fail-Safe & Zero-Harm Design
All operational designs in Electrical & Power Engineering MUST incorporate fail-safe fallback mechanisms. System states must fail closed to prevent physical hazard, data corruption, or financial loss.
