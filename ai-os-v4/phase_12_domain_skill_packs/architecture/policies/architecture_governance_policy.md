---
title: "Sustainable Building & Passive Design Compliance Policy"
document_id: "SPEC-P12-ARCH-POL-001"
...
# Sustainable Building & Passive Design Compliance Policy

## 1. Policy Purpose & Authority
This policy establishes binding operational, safety, and regulatory compliance rules for all tasks executed in the **Architectural Design** domain. It derives authority from the enterprise AI OS v4 Runtime Policy Engine and enforces strict compliance with international standards: **AIA Document Standards, ISO 19650 (BIM), LEED v4.1, IBC Accessibility (ADA)**.

---

## 2. Scope & Applicability
This policy applies to:
1. All AI OS agents executing in the `architecture` domain context.
...
Every generated artifact MUST explicitly reference and comply with at least one governing standard from: `AIA Document Standards, ISO 19650 (BIM), LEED v4.1, IBC Accessibility (ADA)`. Non-compliant deliverables MUST be automatically rejected at the verification gate.

### Rule 2: Fail-Safe & Zero-Harm Design
All operational designs in Architectural Design MUST incorporate fail-safe fallback mechanisms. System states must fail closed to prevent physical hazard, data corruption, or financial loss.
