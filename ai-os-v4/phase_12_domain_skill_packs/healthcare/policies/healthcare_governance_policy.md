---
title: "Patient Health Information (PHI) Security & HIPAA Compliance Policy"
document_id: "SPEC-P12-HEALTH-POL-001"
...
# Patient Health Information (PHI) Security & HIPAA Compliance Policy

## 1. Policy Purpose & Authority
This policy establishes binding operational, safety, and regulatory compliance rules for all tasks executed in the **Healthcare & Clinical Operations** domain. It derives authority from the enterprise AI OS v4 Runtime Policy Engine and enforces strict compliance with international standards: **HIPAA Privacy/Security, HL7 FHIR v4, DICOM, FDA 21 CFR Part 820, ISO 13485**.

---

## 2. Scope & Applicability
This policy applies to:
1. All AI OS agents executing in the `healthcare` domain context.
...
Every generated artifact MUST explicitly reference and comply with at least one governing standard from: `HIPAA Privacy/Security, HL7 FHIR v4, DICOM, FDA 21 CFR Part 820, ISO 13485`. Non-compliant deliverables MUST be automatically rejected at the verification gate.

### Rule 2: Fail-Safe & Zero-Harm Design
All operational designs in Healthcare & Clinical Operations MUST incorporate fail-safe fallback mechanisms. System states must fail closed to prevent physical hazard, data corruption, or financial loss.
